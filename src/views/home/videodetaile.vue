<template>
  <div class="home">
    ...
    <!-- <video
      class="video-player vjs-custom-skin"
      src="http://mfyfile.greatorange.cn/MFYVideo1611813886594町洋0150无水印中文加S.mp4"
    ></video> -->
    <div class="foolter">
      <div class="desc">
        {{ videoinfo.name }}
    ...
    >
      <div class="comment">
        ...
        <div class="cmmentlist">
          ...
          <!-- <ul v-show="comment.length > 0" class="list">
            <li class="listblock" v-for="item in comment" :key="item.id">
              <van-image class="headimgurl" round width="50px" height="50px" :src="item.headimgurl" />
              <div class="commentblock">
                <div class="commentblock-header flexstart">
...
<script>
import { getVideoDetails, zanVideo, comment_video, collect_video, getVideoComment } from '@/api/user.js'
...
export default {
  ...
  methods: {
    ...
    getVideoDetails() {
      ...
      getVideoDetails({ video_id: this.$route.query.id }).then(res => {
        console.log(res, 'getVideoDetails')
