<template>
  <div :class="is_ios ? 'IOSstyle' : 'homepage'">
    <div class="header">
      ...
      <div class="header-desc">
        ...
        <div class="flexstart desc" style="color: var(--gzh-color)">
          <i class="iconfont icon-guanzhuchenggong iconlogo"></i>{{ numman }}个朋友关注
        </div>
        <div class="flexstart desc">
          <a
            ...
            target="_blank"
          >
            <i class="iconfont icon-geren icongzlogo"></i>公众号：盛视天橙·DESIGN
          </a>
        </div>
      </div>
